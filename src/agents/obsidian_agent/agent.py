...
async def run_obsidian_agent(task: str) -> str:
    """
    Executes the Obsidian Agent on the given task and returns the agent's output.

    Parameters:
        task (str): The task description or instruction for the agent to process.

    Returns:
        str: The output generated by the agent for the provided task.
    """
